...
parameters {
  ...
  real<lower=0.01> sigma_b_0_s;
  
  real<lower=0.01> sigma_b_s;
...
model {
  ...
  b_tdd_5_X_td_s ~ normal(0,sigma_b_s);
  b_tdd_9_X_td_s ~ normal(0,sigma_b_s);
  b_tdd_14_X_td_s ~ normal(0,sigma_b_s);
