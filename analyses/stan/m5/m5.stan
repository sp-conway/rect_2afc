...
parameters {
  ...
  // Std. Dev. of random effect of wide
  real<lower=0> sigma_b_w_s;
  
  // random effect of horizontal
  vector[n_subs] b_h_s;
  
  // Std. Dev. of random effect of horizontal display
  real<lower=0> sigma_b_h_s;
  ...
  // Std. Dev. of random effect of tdd and tdd - td interaction
...
model {
  ...
  b_tdd_5_X_td_s ~ normal(0,sigma_b_tdd_s);
  b_tdd_9_X_td_s ~ normal(0,sigma_b_tdd_s);
  b_tdd_14_X_td_s ~ normal(0,sigma_b_tdd_s);
